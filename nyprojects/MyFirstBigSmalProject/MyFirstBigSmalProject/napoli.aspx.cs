...
{
    public partial class napoli : System.Web.UI.Page
    {
        [Inject]
        ...
        protected void public_Click(object sender, EventArgs e)
        {
            ...
            this.KomentariServices.AddCommentForTeam(user, message, "napoli");
        ...
        {
            return this.KomentariServices.GetAllCommentsForTeam("napoli");
        }
    }
}