...
{
    public partial class juventus : System.Web.UI.Page
    {
        [Inject]
        ...
        protected void public_Click(object sender, EventArgs e)
        {
            ...
            this.KomentariServices.AddCommentForTeam(user, message, "juventus");
        ...
        {
            return this.KomentariServices.GetAllCommentsForTeam("juventus");
        }
    }
}