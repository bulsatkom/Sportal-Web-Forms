...
{
    public partial class roma : System.Web.UI.Page
    {
        [Inject]
        ...
        protected void public_Click(object sender, EventArgs e)
        {
            ...
            this.KomentariServices.AddCommentForTeam(user, message, "roma");
        ...
        {
            return this.KomentariServices.GetAllCommentsForTeam("roma");
        }
    }
}