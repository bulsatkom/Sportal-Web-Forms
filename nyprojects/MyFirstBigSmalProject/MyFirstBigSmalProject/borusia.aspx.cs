...
{
    public partial class borusia : System.Web.UI.Page
    {
        [Inject]
        ...
        protected void public_Click(object sender, EventArgs e)
        {
            ...
            this.KomentariServices.AddCommentForTeam(user, message, "borusia");
        ...
        {
            return this.KomentariServices.GetAllCommentsForTeam("borusia");
        }
    }
}