...
{
    public partial class leichester : System.Web.UI.Page
    {
        [Inject]
        ...
        protected void public_Click(object sender, EventArgs e)
        {
            ...
            this.KomentariServices.AddCommentForTeam(user, message, "leicester");
        ...
        {
            return this.KomentariServices.GetAllCommentsForTeam("leicester");
        }
    }
}