...
{
    public partial class mancity : System.Web.UI.Page
    {
        [Inject]
        ...
        protected void public_Click(object sender, EventArgs e)
        {
            ...
            this.KomentariServices.AddCommentForTeam(user, message, "mancity");
        ...
        {
            return this.KomentariServices.GetAllCommentsForTeam("mancity");
        }
    }
}