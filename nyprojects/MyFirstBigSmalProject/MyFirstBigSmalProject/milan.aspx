<%@ Page Title="" Language="C#" MasterPageFile="~/otbori.master" AutoEventWireup="true" CodeBehind="milan.aspx.cs" Inherits="MyFirstBigSmalProject.milan" %>
<asp:Content runat="server" ContentPlaceHolderID="imageholder">
    <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/d/db/AC_Milan.svg/150px-AC_Milan.svg.png" width="200" height="200"/>
</asp:Content>
<asp:Content runat="server" ContentPlaceHolderID="zaglavie"><div class="backgroundzaglaviemilan">
    <div class="text-center zaglaviepaddingmilan">Милан</div></div></asp:Content>
<asp:Content runat="server" ContentPlaceHolderID="prozvi6te">
    <ul>
        ...
        <li>Италия<hr /></li>
        <li>Милано<hr /></li>
        <li>Ли Йонгхонг<hr /></li>
        <li>Виченцо Монтела<hr /></li>
        <li>Сан Сиро<hr /></li>
        <li>80 018<hr /></li>
        <li>Интер, Ювентус<hr /></li>
        <li>www.acmilan.com<hr /></li>
    </ul>
</asp:Content>
