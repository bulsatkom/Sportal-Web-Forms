<%@ Page Title="" Language="C#" MasterPageFile="~/otbori.master" AutoEventWireup="true" CodeBehind="napoli.aspx.cs" Inherits="MyFirstBigSmalProject.napoli" %>
<asp:Content runat="server" ContentPlaceHolderID="imageholder">
    <img src="http://www.bgbets.com/wp-content/uploads/2016/09/napoli.png" width="200" height="200"/>
</asp:Content>
<asp:Content runat="server" ContentPlaceHolderID="zaglavie"><div class="backgroundzaglavienapoli">
    <div class="text-center zaglaviepaddingjuventus">Наполи</div></div>

</asp:Content>
<asp:Content runat="server" ContentPlaceHolderID="prozvi6te">
    <ul>
        <li>ССК Наполи<hr /></li>
        <li>Неаполитанци<hr /></li>
        <li>1926<hr /></li>
        <li>Италия<hr /></li>
        <li>Неапол<hr /></li>
        <li>Аурелио Де Лаурентис<hr /></li>
        <li>Маурицио Сари<hr /></li>
        <li>Сан Паоло<hr /></li>
        <li>60 240<hr /></li>
        <li>Рома, Лацио, Верона<hr /></li>
        <li>www.sscnapoli.it<hr /></li>
    </ul>
</asp:Content>
