...
{
    public partial class milan : System.Web.UI.Page
    {
        [Inject]
        ...
        protected void public_Click(object sender, EventArgs e)
        {
            ...
            this.KomentariServices.AddCommentForTeam(user, message, "milan");
        ...
        {
            return this.KomentariServices.GetAllCommentsForTeam("milan");
        }
    }
}