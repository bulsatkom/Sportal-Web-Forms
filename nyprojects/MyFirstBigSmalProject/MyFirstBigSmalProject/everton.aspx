<%@ Page Title="" Language="C#" MasterPageFile="~/otbori.master" AutoEventWireup="true" CodeBehind="everton.aspx.cs" Inherits="MyFirstBigSmalProject.everton" %>
<asp:Content runat="server" ContentPlaceHolderID="imageholder">
    <img src="http://profootball.bg/wp-content/uploads/2016/12/650.png" width="200" height="200"/>
</asp:Content>
<asp:Content runat="server" ContentPlaceHolderID="zaglavie">
    <div class="backgroundzaglaviechelsea"><div class="text-center zaglaviepaddingchelsea">Евъртън</div></div>
</asp:Content>
<asp:Content runat="server" ContentPlaceHolderID="prozvi6te">
    <ul>
        ...
        <li>Англия<hr /></li>
        <li>Ливърпул<hr /></li>
        <li>Бил Кенрайт<hr /></li>
        <li>Роналд Куман<hr /></li>
        <li>Гудисън Парк<hr /></li>
        <li>40 569<hr /></li>
        <li>Ливърпул<hr /></li>
        <li>www.evertonfc.com<hr /></li>
    </ul>
</asp:Content>
