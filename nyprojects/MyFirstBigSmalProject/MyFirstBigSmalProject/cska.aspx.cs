...
{
    public partial class cska : System.Web.UI.Page
    {
        [Inject]
        ...
        protected void public_Click(object sender, EventArgs e)
        {
            ...
            this.KomentariServices.AddCommentForTeam(user, message, "cska");
        ...
        {
            return this.KomentariServices.GetAllCommentsForTeam("cska");
        }
    }
}