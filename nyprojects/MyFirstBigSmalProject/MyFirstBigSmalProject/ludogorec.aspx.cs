...
{
    public partial class ludogorec : System.Web.UI.Page
    {
        [Inject]
        ...
        protected void public_Click(object sender, EventArgs e)
        {
            ...
            this.KomentariServices.AddCommentForTeam(user, message, "ludogorec");
        ...
        {
            return this.KomentariServices.GetAllCommentsForTeam("ludogorec");
        }
    }
}