...
{
    public partial class barselona : System.Web.UI.Page
    {
        [Inject]
        ...
        protected void public_Click(object sender, EventArgs e)
        {
            ...
            this.KomentariServices.AddCommentForTeam(user, message, "barselona");
        ...
        {
            return this.KomentariServices.GetAllCommentsForTeam("barselona");
        }
    }
}