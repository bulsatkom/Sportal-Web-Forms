...
{
    public partial class atletiko : System.Web.UI.Page
    {
        [Inject]
        ...
        protected void public_Click(object sender, EventArgs e)
        {
            ...
            this.KomentariServices.AddCommentForTeam(user, message, "atletiko");
        ...
        {
            return this.KomentariServices.GetAllCommentsForTeam("atletiko");
        }
    }
}