...
{
    public partial class tothnam : System.Web.UI.Page
    {
        [Inject]
        ...
        protected void public_Click(object sender, EventArgs e)
        {
            ...
            this.KomentariServices.AddCommentForTeam(user, message, "totthnam");
        ...
        {
            return this.KomentariServices.GetAllCommentsForTeam("totthnam");
        }
    }
}