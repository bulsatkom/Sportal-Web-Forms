...
{
    public partial class levski : System.Web.UI.Page
    {
        [Inject]
        ...
        protected void public_Click(object sender, EventArgs e)
        {
            ...
            this.KomentariServices.AddCommentForTeam(user, message, "levski");
        ...
        {
            return this.KomentariServices.GetAllCommentsForTeam("levski");
        }
    }
}