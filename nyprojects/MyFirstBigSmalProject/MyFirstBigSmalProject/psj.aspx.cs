...
{
    public partial class psj : System.Web.UI.Page
    {
        [Inject]
        ...
        protected void public_Click(object sender, EventArgs e)
        {
            ...
            this.KomentariServices.AddCommentForTeam(user, message, "psj");
        ...
        {
            return this.KomentariServices.GetAllCommentsForTeam("psj");
        }
    }
}