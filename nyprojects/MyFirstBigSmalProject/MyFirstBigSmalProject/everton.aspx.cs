...
{
    public partial class everton : System.Web.UI.Page
    {
        [Inject]
        ...
        protected void public_Click(object sender, EventArgs e)
        {
            ...
            this.KomentariServices.AddCommentForTeam(user, message, "everton");
        ...
        {
            return this.KomentariServices.GetAllCommentsForTeam("everton");
        }
    }
}