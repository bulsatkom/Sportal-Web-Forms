...
{
    public partial class liverpool : System.Web.UI.Page
    {
        [Inject]
        ...
        protected void public_Click(object sender, EventArgs e)
        {
            ...
            this.KomentariServices.AddCommentForTeam(user, message, "liverpool");
        ...
        {
            return this.KomentariServices.GetAllCommentsForTeam("liverpool");
        }
    }
}