...
{
    public partial class arsenal : System.Web.UI.Page
    {
        [Inject]
        ...
        protected void public_Click(object sender, EventArgs e)
        {
            ...
            this.KomentariServices.AddCommentForTeam(user, message, "arsenal");
        ...
        {
            return this.KomentariServices.GetAllCommentsForTeam("arsenal");
        }
    }
}